...
const mn = {
  appName: 'Усион Олимп',
  tagline: '2–10 тамирчин · 5 төрөл · нэг медалийн хүснэгт',
  ...
  htWind: 'Дугуй зур — хурдлуул',
  htRelease: 'НОГООН болоход тавь',
  htFlight: 'Нисэж байна…',
  htDone: 'Гурван оролдлого дууслаа',
  htHint: 'Хүрээн дотор дугуй зур — ногоон болоход хуруугаа авч тавь',
  htGreen: 'ТАВЬ!',
  htFoul: 'ХҮРЭЭНЭЭС ГАРЛАА',
  htOutOfSector: 'талбайгаас гарлаа',
  htNoThrow: 'тавьсангүй',
  htSpin: 'Эргэлт',
  htTurns: 'эргэлт',
  htBest: 'шилдэг шидэлт',
  htMeasuring: 'Хэмжиж байна…',
  htAttempt: (n, total) => `${n}/${total} оролдлого`,
...
const en = {
  ...
  tagline: '2–10 athletes · 5 events · one medal table',
  ...
  htWind: 'Circle to wind her up',
  htRelease: 'Release on GREEN',
  htFlight: 'In the air…',
  htDone: 'All three attempts used',
  htHint: 'Draw circles inside the ring — let go the moment the arrow turns green',
  htGreen: 'LET GO!',
  htFoul: 'LEFT THE CIRCLE',
  htOutOfSector: 'outside the sector',
  htNoThrow: 'never let go',
  htSpin: 'Spin',
  htTurns: 'turns',
  htBest: 'best throw',
  htMeasuring: 'Measuring…',
  htAttempt: (n, total) => `attempt ${n}/${total}`,
