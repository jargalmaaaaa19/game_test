...
const mn = {
  ...
  leftFoot: 'ЗҮҮН',
  rightFoot: 'БАРУУН',
  sprintHint: 'Зүүн–баруун ээлжлэн хурдан дар (эсвэл Space)',
  archeryAim: 'Өнцгөө сонго — дэлгэц дээр дар',
  archeryPower: 'Хүчээ сонго — дахин дар',
  archeryDone: 'Гурван сум дууслаа',
  archeryHint: 'Салхины эсрэг чиглүүл. Хоёр товшилт: өнцөг, дараа нь хүч',
  power: 'Хүч',
  wind: 'Салхи',
  arrowsLeft: (n) => `${n} сум үлдсэн`,
  ljRun: 'Гүй — товчийг хурдан дар',
  ljAngle: 'Өнцгөө сонго — 45°-д тавь',
  ljDone: 'Гурван оролдлого дууслаа',
  ljHint: 'Улаан зурааст хүрэхээс өмнө үсэр. Даран барьж, 45°-д тавь',
  ljRunBtn: 'ГҮЙХ',
  ljJumpBtn: 'ҮСРЭХ',
  speed: 'Хурд',
  foul: 'алдаа',
  attemptsLeft: (n) => `${n} оролдлого`,
  swimL: 'ЗҮҮН',
  swimR: 'БАРУУН',
  swimHint: 'Тэмдэг зураас дээр ирэхэд тохирох талыг дар',
...
const en = {
  ...
  leftFoot: 'LEFT',
  rightFoot: 'RIGHT',
  sprintHint: 'Alternate left–right fast (or hammer Space)',
  archeryAim: 'Pick your angle — tap the screen',
  archeryPower: 'Pick your power — tap again',
  archeryDone: 'All three arrows away',
  archeryHint: 'Aim into the wind. Two taps: angle, then power',
  power: 'Power',
  wind: 'Wind',
  arrowsLeft: (n) => `${n} arrows left`,
  ljRun: 'Run — tap fast',
  ljAngle: 'Set the angle — release at 45°',
  ljDone: 'All three attempts used',
  ljHint: 'Take off on or before the red board. Hold, release at 45°',
  ljRunBtn: 'RUN',
  ljJumpBtn: 'JUMP',
  speed: 'Speed',
  foul: 'foul',
  attemptsLeft: (n) => `${n} attempts`,
  swimL: 'LEFT',
  swimR: 'RIGHT',
  swimHint: 'Press the matching side as the cue reaches the line',
